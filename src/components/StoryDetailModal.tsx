...
export const StoryDetailModal: React.FC<StoryDetailModalProps> = ({ isOpen, story, onClose, onRestore }) => {
    // Handle escape key
    useEffect(() => {
      ...
      <div className="bg-bg-primary rounded-xl shadow-devsuite-modal border border-border-default w-full max-w-[600px] max-h-[95vh] overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-border-default relative">
          <div className="flex items-center gap-3 mb-2">
            <div className="flex items-center gap-2">
              ...
              {story.completed && (<span className="flex items-center gap-1 text-xs bg-success-light text-success-dark px-2 py-0.5 rounded-full">
                  <CheckCircle className="w-3 h-3"/>
                  Completed
                </span>)}
              {story.archivedAt && (<span className="flex items-center gap-1 text-xs bg-warning-light text-warning-dark px-2 py-0.5 rounded-full">
        ...
        <div className="px-6 py-4 overflow-y-auto max-h-[calc(95vh-200px)]">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              {story.completedAt && (<div className="flex items-center gap-2">
              ...
              {story.archivedAt && (<div className="flex items-center gap-2">
            ...
            {/* Tags */}
            {story.tags.length > 0 && (<div>
                <h3 className="font-semibold text-text-primary mb-2">Tags</h3>
                <div className="flex flex-wrap gap-2">
                  {story.tags.map(tag => (<span key={tag} className="inline-flex items-center gap-1 px-3 py-1 bg-devsuite-primary-subtle text-devsuite-primary text-sm rounded-full">
        ...
        <div className="px-6 py-4 border-t border-border-default flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            {story.archivedAt && (<button onClick={handleRestore} className="flex items-center gap-2 px-4 py-2 bg-success text-text-inverse text-sm font-medium rounded-lg hover:bg-success-dark transition-all">
