      ...
      <div className="bg-bg-primary rounded-xl shadow-devsuite-modal border border-border-default w-full max-w-[500px]">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className={`w-5 h-5 border-2 rounded-full flex items-center justify-center ${
                    ...
                    {exportFormat === 'json' && (
                      <div className="w-2.5 h-2.5 bg-text-inverse rounded-full"></div>
                    )}
                  </div>
        ...
        <div className="px-6 py-3 border-t border-border-default flex justify-end gap-3">
          <button
            ...
            onClick={onClose}
            disabled={exporting}
            className="flex items-center gap-1.5 px-4 py-2 bg-transparent text-text-secondary text-sm font-medium cursor-pointer border border-border-default rounded-lg transition-all hover:bg-bg-muted hover:text-text-primary disabled:opacity-50"
          >
            Cancel
          </button>
          <button
            ...
            disabled={exporting}
            className="flex items-center gap-1.5 px-4 py-2 bg-devsuite-primary text-text-inverse text-sm font-medium cursor-pointer border border-devsuite-primary rounded-lg transition-all hover:bg-devsuite-primary-hover disabled:opacity-50"
          >
