...
if (!supabaseUrl || !supabaseAnonKey ||
    ...
    debug.warn("supabase_fix.ts", '⚠️ Supabase configuration may be incomplete');
    debug.info("supabase_fix.ts", "Current URL", { supabaseUrl  });
    debug.info("supabase_fix.ts", "Key status", { supabaseAnonKey ? '[SET]'  '[MISSING]'  });
