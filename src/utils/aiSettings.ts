...
export function loadAISettings(): AISettings {
    try {
        ...
        debug.error("aiSettings.ts", "Error loading AI settings", { error  });
    }
...
export function saveAISettings(settings: AISettings): void {
    try {
        ...
        debug.error("aiSettings.ts", "Error saving AI settings", { error  });
...
export function clearAISettings(): void {
    try {
        ...
        debug.error("aiSettings.ts", "Error clearing AI settings", { error  });
    }
}
